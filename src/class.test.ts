...
staticAssert((that) =>
    that.type<typeof DifferentInstance>().notExtends<ExampleClass>(),
);
...
staticAssert((that) =>
    that.type<typeof LessParameters>().extends<ExampleClass>(),
);
...
staticAssert((that) =>
    that.type<typeof MoreParameters>().notExtends<ExampleClass>(),
);
...
staticAssert((that) =>
    that.type<typeof DifferentParameters>().notExtends<ExampleClass>(),
);
